...
module.exports = function(options, callback) {
  ...
  yahoo.where(options, function(err, woeid) {
    if(err){
      callback(err);
    } else{
...
var onError = function(msg) {
  ...
  // Note that assignment to module.exports must be done immediately. 
  // It cannot be done in any callbacks. The following will not work.
  ...
  request(url, function(error, res, body) {
    ...
    parser.parseString(body, function(err, result) {
      ...
      try {
        ...
        callback("Failed to find weather", weather);
        return;
      }
    ...
    if (body) {
      parser.parseString(body, function(err, result) {
        try {
          ...
          callback('Failed to fetch woeid');
        }
      });
    } else {
      callback('Failed to fetch woeid');
